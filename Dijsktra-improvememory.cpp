...
int main()
{
	...
	printf("Size of: AdjListNode - %lu, AdjList - %lu, Graph - %lu\n", sizeof(struct AdjListNode), sizeof(struct AdjList), sizeof(struct Graph));
	/*process("graph-small.txt");	
	process("graph-medium.txt");
	process("graph-1000.txt");
	process("graph-10000.txt");*/
	process("graph-64000.txt");
	process("90000.txt");
	process("largeEWD.txt");
